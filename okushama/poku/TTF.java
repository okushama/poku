 ...
 * @author Robert Shave (Mr_okushama)
 * 
 * 
 */
public class TTF implements org.newdawn.slick.Font {
	 ...
	 */
	public TTF(java.awt.Font font, boolean antiAlias, char[] additionalChars) {
	 ...
	 *            Whether or not to apply AntiAliasing to the cached font
	 */
	public TTF(java.awt.Font font, boolean antiAlias) {
	...
	private void drawQuad(float drawX, float drawY, float drawX2, float drawY2,
		...
		// The Developer of Slick-Utils messed up here...
	...
	public void drawString(float x, float y, String whatchars,
			org.newdawn.slick.Color color,float alpha) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1,alpha);
	}
	 ...
	 */
	public void drawString(float x, float y, String whatchars,
			org.newdawn.slick.Color color, int startIndex, int endIndex, float alpha) {
		color.bind();
		fontTexture.bind();
